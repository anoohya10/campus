...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="post_vacancies.php">
          <i class="fas fa-fw fa-file-circle-plus"></i>
          <span>Post Vacancy</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="manage_vacancies.php">
          <i class="fas fa-fw fa-file-circle-plus"></i>
          <span>Manage Vacancy</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="job_applications.php">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                ?>
                    <img class="img-profile rounded-circle" style="object-fit: cover;" src="<?php echo getCmpImage($row['cmp_logo']); ?>" />
                <?php
                  }
                }
                ?>
