...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Registered Company -->
            <li class="nav-item active">
                <a class="nav-link" href="reg_companies.php">
                    <!-- <i class="fas fa-fw fa-tachometer-alt"></i> -->
                    <i class="fas fa-fw fa-users"></i>
                    <span>Registered Companies</span></a>
            </li>

            <!-- Nav Item - Students registered -->
            <li class="nav-item active">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="about-us-editor.php">About Us</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                ?>
                                        <img class="img-profile rounded-circle" style="object-fit: cover;" src="<?php echo getImage($row['profile_img']); ?>" />
                                <?php
                                    }
                                }
                                ?>
